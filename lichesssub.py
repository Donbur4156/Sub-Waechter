...
async def commands(ctx):
    ...
    embed = discord.Embed(title="**Commands**", color=discord.Color.to_rgb(87, 62, 7), description=text)
...
async def modcommands(ctx):
    ...
    embed = discord.Embed(title="**Mod Commands**", color=discord.Color.to_rgb(87, 62, 7), description=text)
